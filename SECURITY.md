...
Esta política se aplica ao projeto Amigo Secreto, mantido por Jéssica Ferreira Teixeira. Agradeço qualquer contribuição responsável para a segurança do código.
...
### **2. Informações Necessárias no E-mail**
...
### **3. Meu Compromisso de Resposta**

Como mantenedor único, farei o meu melhor para garantir um tempo de resposta ágil:

1.  **Confirmação:** Tentarei enviar uma confirmação de recebimento do seu e-mail em até **48 horas**.
2.  **Correção:** Após a validação, farei o possível para desenvolver e lançar uma correção em uma nova versão o mais rápido possível.
3.  **Divulgação:** A vulnerabilidade será divulgada publicamente (no histórico de *releases* ou em uma nota) **somente após a correção ser lançada**.
